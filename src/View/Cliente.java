...
public class Cliente extends javax.swing.JFrame {
     ...
     */
  public void Listar(){
    ClienteB dao = new ClienteB();
    List<ClienteA>lista = dao.listar();
    DefaultTableModel dados = (DefaultTableModel) tabela_cliente.getModel();
    dados.setNumRows(0);
    for(ClienteA u : lista ){
    ...
    private void initComponents() {
        ...
        btn_voltar2.setBackground(new java.awt.Color(102, 102, 102));
                    ...
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addGroup(jPanel2Layout.createSequentialGroup()
                                ...
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                                .addComponent(txt_endereco, javax.swing.GroupLayout.PREFERRED_SIZE, 240, javax.swing.GroupLayout.PREFERRED_SIZE))
                            .addGroup(jPanel2Layout.createSequentialGroup()
        ...
        tabela_cliente.setBorder(javax.swing.BorderFactory.createEtchedBorder());
        tabela_cliente.setFont(new java.awt.Font("Sitka Small", 1, 12)); // NOI18N
        tabela_cliente.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {

            },
            new String [] {
                "CÓDIGO", "NOME", "CONTACTO", "EMAIL", "ENDERECO", "DATA DE CADASTRO"
            }
        ) {
    ...
    private void btn_removerActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_removerActionPerformed
        ...
        ClienteA obj = new ClienteA(); 
         obj.setIdcliente(Integer.valueOf(txt_codigo.getText()));
         ClienteB clienteb= new ClienteB();
         clienteb.Remover(obj);
         ClienteB.Limpar limp = clienteb.new Limpar();
        limp.LimparCliente(jPanel2);
   ...
   ClienteB clienteb = new ClienteB();
    ...
    private void btn_pesquisarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_pesquisarActionPerformed
       ...
       String nome =txt_nome.getText();
        ...
        if(obj.getNome()!=null && !nome.trim().isEmpty()){
            ...
            txt_codigo.setText(String.valueOf(obj.getIdcliente()));
    ...
    private void btn_novoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_novoActionPerformed
        // TODO add your handling code here:
        ClienteB cadastro = new ClienteB();
        ClienteB.Limpar limp = cadastro.new Limpar();
        limp.LimparCliente(jPanel2);
   ...
   obj.setEmail(txt_email.getText());
   obj.setContacto(txt_contacto.getText());
   obj.setContacto(txt_endereco.getText());
   obj.setContacto(txt_data.getText());
   obj.setIdcliente(Integer.valueOf(txt_codigo.getText()));
   ...
   dao.Atualizar(obj);
    ...
    private void tabela_clienteMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tabela_clienteMouseClicked
        ...
        int selecttedRow = tabela_cliente.getSelectedRow();
        btn_atualizar.setEnabled(true);
        btn_remover.setEnabled(true);
        
        if(selecttedRow != -1){
        String codigo = tabela_cliente.getValueAt(selecttedRow, 0).toString();
        String nome = tabela_cliente.getValueAt(selecttedRow, 1).toString();
        String Contacto = tabela_cliente.getValueAt(selecttedRow, 2).toString();
        String email = tabela_cliente.getValueAt(selecttedRow, 3).toString();
      String endereco = tabela_cliente.getValueAt(selecttedRow, 4).toString();
        String data = tabela_cliente.getValueAt(selecttedRow, 5).toString();
        ...
        txt_data.setText(email);
        txt_endereco.setText(email);
        }
